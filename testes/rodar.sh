...
for (const fn of ["cobranca-atende","cobranca-seguir","cobranca-emitidos","cobranca-painel"]) {
...
falhou=0
for t in boleto_pdf qr montar boleto_mensagem assinatura marca conversa emitidos saude; do
  printf '%-18s ' "$t"
